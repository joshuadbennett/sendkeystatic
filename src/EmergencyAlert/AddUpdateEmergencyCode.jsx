...
export default class AddUpdateEmergencyCode extends React.Component {
    constructor(props) {
        super(props);
        let editMode = false;
    ...
    validate = (e) => {
        ...
        if (formValid) {
            ...
            let action = "EmergencyAlerts/Account/" + this.state.accountId + "/Codes/BulkUpload";
    ...
    hideAlert = (e) => {
        ...
        if (this.state.complete) {
            this.props.history.push({
                pathname: "/Layout/EmergencyCodes",
                        ...
                        <div className="card-header">
                            <div className="row">
                                <div className="col-md-8 col-lg-8 col-xl-8">
                                    <h2 className="card-title">{editMode ? "Edit" : "Create"} Emergency Codes{editMode ? " - " + this.state.displayName : ""}</h2>
                                </div>
