...
$(document).ready(function () {
    var dashboardRefreshIntervalMillis = 5000, dashboardChartItems = 10;
    ...
    require(
        ...
        function (ec) {
            ...
            chartOptions = {
                ...
                // Add Legend
                legend: {
                    data: ['Transactions', 'Servers Online']
                },
                ...
                xAxis: [
                    {
                        ...
                        data: (function () {
                            var now = new Date();
                            var res = [];
                            var len = dashboardChartItems;
                            while (len--) {
                                res.unshift(now.toLocaleTimeString().replace(/^\D*/, ''));
                                now = new Date(now - dashboardRefreshIntervalMillis);
                            }
                            return res;
                        })()
                    },
            ...
            $(function () {
                ...
                var timeTicket = setInterval(function () {
                    var jqxhr = $.ajax("https://localhost:example.php")
                        .done(function () {
                            console.log("success");
                ...
                }, dashboardRefreshIntervalMillis);
            });
        }
    );
});